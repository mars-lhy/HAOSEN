...
DPCAPI  BOOL    DpcSetSpiSelect(HANDLE hif, int idSel, ERC * perc, TRID * ptrid);
DPCAPI  BOOL    DpcSetSpiMode(HANDLE hif, int idMode, int idDir, 
							  ERC * perc, TRID * ptrid);

DPCAPI  BOOL    DpcPutSpiByte(HANDLE hif, BYTE bSnd, BYTE * pbRcv,
							  ERC * perc, TRID * ptrid);

DPCAPI  BOOL    DpcPutSpi(HANDLE hif, int cbSnd, BYTE * rgbSnd, BYTE * rgbRcv,
						  ERC * perc, TRID * ptrid);

DPCAPI  BOOL    DpcGetSpi(HANDLE hif, int cbRcv, BYTE bFill, BYTE * rgbRcv,
						  ERC * perc, TRID * ptrid);
